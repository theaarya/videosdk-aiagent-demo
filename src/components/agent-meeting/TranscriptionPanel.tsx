...
export const TranscriptionPanel: React.FC<TranscriptionPanelProps> = ({
  ...
  if (!isVisible) {
    return (
      <Button
        ...
        className="fixed bottom-4 right-4 w-14 h-14 rounded-full bg-[#121619] hover:bg-[#25252540] border border-[#38BDF8]/30 shadow-lg"
      >
  ...
  return (
    <div className="fixed bottom-4 right-4 w-80 h-96 bg-[#121619] border border-[#38BDF8]/30 rounded-lg shadow-xl flex flex-col">
      {/* Header */}
      <div className="flex items-center justify-between p-4 border-b border-[#25252540]">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button
            onClick={onToggleVisibility}
            size="sm"
            className="w-8 h-8 bg-[#25252540] hover:bg-[#38BDF8]/20 text-gray-300"
          >
            <X className="w-4 h-4" />
          </Button>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* Footer */}
        {transcriptions.length > 0 && (
          <div className="p-3 border-t border-[#25252540]">
            <Button
              onClick={clearTranscriptions}
              size="sm"
              variant="outline"
              className="w-full text-xs border-[#38BDF8]/30 text-gray-300 hover:bg-[#25252540]"
            >
              Clear All
            </Button>
          </div>
